...
This document tracks the local Xcode release process and App Store Connect items needed to ship mobile-claw with RevenueCat-powered subscriptions.

## Current App Identifiers

- App name: `mobile-claw`
- Bundle ID: `com.flex-lol.mobile-claw`
- Apple Team ID: keep local to the release environment
- App Store Connect app ID: keep local to the release environment
- RevenueCat entitlement: `mobile-claw Pro`
- RevenueCat offering: `default`
- RevenueCat packages:
  - `$rc_monthly`
  - `$rc_annual`
- App Store subscription group: `mobile-claw Pro`
- App Store products:
  - `com.flex-lol.mobile-claw.pro.monthly`
  - `com.flex-lol.mobile-claw.pro.yearly`
...
- [ ] `mobile-claw Pro Monthly` is configured
- [ ] `mobile-claw Pro Yearly` is configured
- [ ] Both are in the same subscription group: `mobile-claw Pro`
...
- [ ] `default` offering uses:
  - [ ] `$rc_monthly` -> `com.flex-lol.mobile-claw.pro.monthly`
  - [ ] `$rc_annual` -> `com.flex-lol.mobile-claw.pro.yearly`
- [ ] `mobile-claw Pro` entitlement is attached to both products
...
- [ ] `.env.local` or local shell environment contains `EXPO_PUBLIC_REVENUECAT_PRO_ENTITLEMENT_ID=mobile-claw Pro`
...
- [ ] The correct team is selected for the `mobile-claw` target
...
- `ios/mobile-claw.xcworkspace`

Before archiving, verify:

- signing is correct for the main app target
- the selected scheme is `mobile-claw`
