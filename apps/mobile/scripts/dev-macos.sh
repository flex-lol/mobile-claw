...
DERIVED_DATA_PATH="${MACOS_DERIVED_DATA_PATH:-/tmp/mobile-claw-mac-dev}"
APP_NAME="${MACOS_APP_NAME:-mobile-claw}"
WORKSPACE_PATH="$IOS_DIR/mobile-claw.xcworkspace"
SCHEME_NAME="${MACOS_SCHEME:-mobile-claw}"
...
Environment variables:
  ...
  MACOS_DERIVED_DATA_PATH           xcodebuild DerivedData path (default: /tmp/mobile-claw-mac-dev).
  MACOS_APP_NAME                    Built app name (default: mobile-claw).
  MACOS_SCHEME                      Xcode scheme (default: mobile-claw).
  ...
  DEV_MACOS_KILL_RUNNING_APP        Set to 0 to keep an existing mobile-claw.app process alive.
EOF
}
