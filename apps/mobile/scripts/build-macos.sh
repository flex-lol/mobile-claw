...
DERIVED_DATA_PATH="${MACOS_DERIVED_DATA_PATH:-/tmp/mobile-claw-mac-build}"
...
Environment variables:
  ...
  MACOS_DERIVED_DATA_PATH    DerivedData path (default: /tmp/mobile-claw-mac-build).
  MACOS_APP_NAME             App bundle name (default: mobile-claw).
