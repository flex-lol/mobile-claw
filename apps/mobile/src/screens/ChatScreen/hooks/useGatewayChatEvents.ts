...
export function useGatewayChatEvents(params: Params) {
  ...
  useEffect(() => {
    ...
    const appendConnectionRecoveryMessage = (message?: string, code?: string) => {
      ...
      const connectionRecoveryText = i18n.t('Connection Error: Check your network connection and that OpenClaw is running, or run "mobile-claw pair" on your OpenClaw computer, then try again.', { ns: 'chat' });
