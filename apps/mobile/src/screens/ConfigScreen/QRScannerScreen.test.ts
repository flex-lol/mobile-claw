...
describe('parseQRPayload', () => {
  ...
  it('parses mobile-claw pair QR payload', () => {
    const raw = JSON.stringify({
      v: 2,
      k: 'cp',
  ...
  it('parses a new-format mobile-claw pair QR without legacy credentials and keeps relay bootstrap metadata', () => {
    const raw = JSON.stringify({
      v: 2,
      k: 'cp',
      s: 'https://registry.example.com',
  ...
  it('parses mobile-claw pair QR payload with gateway auth token', () => {
    const raw = JSON.stringify({
      v: 2,
      k: 'cp',
      s: 'https://registry.example.com',
  ...
  it('parses mobile-claw pair QR payload with gateway password', () => {
    const raw = JSON.stringify({
      v: 2,
      k: 'cp',
      s: 'https://registry.example.com',
  ...
  it('still parses legacy mobile-claw pair QR payload', () => {
    const raw = JSON.stringify({
      version: 1,
  ...
  it('still parses legacy mobile-claw pair QR payloads with gateway auth credentials', () => {
    const raw = JSON.stringify({
      version: 1,
      kind: 'mobile-claw_pair',
      server: 'https://registry.example.com',
