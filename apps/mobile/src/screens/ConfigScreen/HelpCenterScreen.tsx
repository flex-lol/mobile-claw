    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionDesc}>
          {t("Follow these steps to connect mobile-claw to your OpenClaw.")}
        </Text>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.infoCard}>
          <Text style={styles.infoText}>
            {t(
              "OpenClaw is an open-source AI gateway that runs on your machine. mobile-claw is its mobile companion — it connects to your OpenClaw instance so you can chat with AI agents, manage cron jobs, browse files, and monitor usage from your phone.",
            )}
          </Text>
        </View>
      </View>
