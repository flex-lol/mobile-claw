...
export function GatewaySwitchOverlay({ visible, message }: Props): React.JSX.Element | null {
  ...
  // iOS: FullWindowOverlay renders at the native Window level, above all
  // native-stack modal screens (modal, formSheet, etc.)
  if (Platform.OS === 'ios') {
    return <FullWindowOverlay>{content}</FullWindowOverlay>;
  }

  // Android: RN Modal renders above all other views
  return (
