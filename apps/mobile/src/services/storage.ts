...
const KEYS = {
  identity: 'mobile-claw.identity.v1',
  gatewayConfig: 'mobile-claw.gatewayConfig.v1',
  gatewayProfilesConfig: 'mobile-claw.gatewayProfilesConfig.v1',
  gatewayConfigsState: 'mobile-claw.gatewayConfigsState.v1',
  deviceTokenPrefix: 'mobile-claw.deviceToken.',
  debugMode: 'mobile-claw.debugMode.v1',
  showAgentAvatar: 'mobile-claw.showAgentAvatar.v1',
  themeMode: 'mobile-claw.themeMode.v1',
  accentColor: 'mobile-claw.accentColor.v1',
  customAccentScale: 'mobile-claw.customAccentScale.v1',
  currentAgentId: 'mobile-claw.currentAgentId.v1',
  officeChannelSlots: 'mobile-claw.officeChannelSlots.v1',
  showModelUsage: 'mobile-claw.showModelUsage.v1',
  execApproval: 'mobile-claw.execApproval.v1',
  canvasEnabled: 'mobile-claw.canvasEnabled.v1',
  chatFontSize: 'mobile-claw.chatFontSize.v1',
  chatAppearance: 'mobile-claw.chatAppearance.v1',
  speechRecognitionLanguage: 'mobile-claw.speechRecognitionLanguage.v1',
  lastSessionKey: 'mobile-claw.lastSessionKey.v1',
  lastOpenedSessionSnapshotPrefix: 'mobile-claw.lastOpenedSessionSnapshot.v1',
  cachedAgentIdentityPrefix: 'mobile-claw.cachedAgentIdentity.v1',
  nodeEnabled: 'mobile-claw.nodeEnabled.v1',
  nodeCapabilityToggles: 'mobile-claw.nodeCapabilityToggles.v1',
  userPrompts: 'mobile-claw.userPrompts.v1',
  userPromptsSeeded: 'mobile-claw.userPrompts.seeded.v1',
  promptPeekShown: 'mobile-claw.promptPeekShown.v1',
  proSubscriptionSnapshot: 'mobile-claw.proSubscriptionSnapshot.v1',
} as const;

const NODE_INVOKE_AUDIT_KEY = 'mobile-claw.nodeInvokeAudit.v1';
const MAX_NODE_INVOKE_AUDIT_ENTRIES = 50;
const LEGACY_DASHBOARD_CACHE_KEY = 'mobile-claw.dashboard.cache.v1';
const DASHBOARD_CACHE_PREFIX = 'mobile-claw.dashboard.cache.v2:';
const GATEWAY_CONFIG_BACKUP_PREFIX = 'mobile-claw.gatewayConfigBackup.v1.';
...
export const StorageService = {
  ...
  _draftKey(agentId: string, sessionKey: string): string {
    return `mobile-claw.draft.${agentId}-${sessionKey}`;
  },
  ...
  _cronAckedKey: 'mobile-claw.cron.acked-failures',
