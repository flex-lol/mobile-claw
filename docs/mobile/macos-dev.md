...
- The built app goes to `/tmp/mobile-claw-mac-dev/Build/Products/Debug-maccatalyst/mobile-claw.app` by default.
...
MACOS_DERIVED_DATA_PATH=/tmp/mobile-claw-mac-alt npm run dev:macos
```
